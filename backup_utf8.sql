...
\restrict WnSviwag5TdbMYl95oGVxCjojcZCQHSMXca0SsY8jIS1KAK6eo3PIBpbhP8tRKc
...
--
-- Data for Name: BonusMilestoneClaim; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."BonusMilestoneClaim" DISABLE TRIGGER ALL;
...
ALTER TABLE public."BonusMilestoneClaim" ENABLE TRIGGER ALL;
...
--
-- Data for Name: CardSet; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."CardSet" DISABLE TRIGGER ALL;

INSERT INTO public."CardSet" (id, name, emoji, theme, "rewardText", "seasonId", "createdAt", "updatedAt") VALUES ('cmrd4qlka00039guz9n97kelr', 'Naruto', '🍥', 'Naruto', 'Завершіть колекцію Naruto, щоб отримати ексклюзивну рамку карт', 'cmrd4qlip00009guz9zfelcne', '2026-07-09 06:32:32.938', '2026-07-24 05:22:05.922');


ALTER TABLE public."CardSet" ENABLE TRIGGER ALL;

--
-- Data for Name: Card; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."Card" DISABLE TRIGGER ALL;

INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qlkn00049guzls6xhroe', 'Наруто Узумакі', 'LEGENDARY', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 4200, 7000, '../photo/Naruto/Naruto.webp', 1, '2026-07-09 06:32:32.951', '2026-07-24 05:22:05.933');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qlkw00059guz5dmpeowz', 'Саске Учіха', 'EPIC', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 3400, 5600, '../photo/Naruto/Sasuke.jpg', 1, '2026-07-09 06:32:32.96', '2026-07-24 05:22:05.942');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qll500069guzlkxo9kxk', 'Сакура Харуно', 'RARE', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 1800, 3200, '../photo/Naruto/Sakura.webp', 1, '2026-07-09 06:32:32.969', '2026-07-24 05:22:05.955');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qllc00079guzyyx64oq9', 'Какаші Хатаке', 'EPIC', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 3200, 5200, '../photo/Naruto/Hatake.jpeg', 1, '2026-07-09 06:32:32.976', '2026-07-24 05:22:05.966');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qllm00089guzbr2w5944', 'Мадара Учіха', 'MYTHIC', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 6500, 10000, '../photo/Naruto/Madara.webp', 1, '2026-07-09 06:32:32.986', '2026-07-24 05:22:05.975');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qllt00099guziqluri55', 'Джирайя', 'RARE', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 2000, 3400, '../photo/Naruto/Jiraya.webp', 1, '2026-07-09 06:32:32.993', '2026-07-24 05:22:05.982');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qlm2000a9guz4r8tkcak', 'Хіната Хьюга', 'COMMON', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 1200, 2200, '../photo/Naruto/Hinata.webp', 1, '2026-07-09 06:32:33.002', '2026-07-24 05:22:05.989');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qlm9000b9guzydivsqae', 'Шікамару Нара', 'COMMON', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 1100, 2000, '../photo/Naruto/Shikamaru.webp', 1, '2026-07-09 06:32:33.009', '2026-07-24 05:22:05.996');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qlmg000c9guzkx8s0kug', 'Гаара', 'EPIC', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 3300, 5400, '../photo/Naruto/Gaara.webp', 1, '2026-07-09 06:32:33.016', '2026-07-24 05:22:06.002');
INSERT INTO public."Card" (id, name, rarity, "seasonId", "cardSetId", "basePower", health, "imageUrl", "evolutionLevel", "createdAt", "updatedAt") VALUES ('cmrd4qlmm000d9guz91ui9l7e', 'Ітачі Учіха', 'LEGENDARY', 'cmrd4qlip00009guz9zfelcne', 'cmrd4qlka00039guz9n97kelr', 4400, 7200, '../photo/Naruto/Itachi.webp', 1, '2026-07-09 06:32:33.022', '2026-07-24 05:22:06.008');


ALTER TABLE public."Card" ENABLE TRIGGER ALL;

--
-- Data for Name: CardEvolution; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."CardEvolution" DISABLE TRIGGER ALL;



ALTER TABLE public."CardEvolution" ENABLE TRIGGER ALL;

--
-- Data for Name: CardInstance; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."CardInstance" DISABLE TRIGGER ALL;
...
ALTER TABLE public."CardInstance" ENABLE TRIGGER ALL;

--
-- Data for Name: Clan; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."Clan" DISABLE TRIGGER ALL;
...
ALTER TABLE public."Clan" ENABLE TRIGGER ALL;

--
-- Data for Name: ClanMember; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."ClanMember" DISABLE TRIGGER ALL;
...
ALTER TABLE public."ClanMember" ENABLE TRIGGER ALL;

--
-- Data for Name: ClanQuest; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."ClanQuest" DISABLE TRIGGER ALL;

INSERT INTO public."ClanQuest" (id, "clanId", title, progress, target, "rewardText", "completedAt", "createdAt", "updatedAt", type) VALUES ('cmrstqfeq000qlsuz7m8vu08y', 'cmrd4qlmr000e9guzwwu1jk9i', 'Здобудьте разом 500 карток', 4, 500, '+50 000 коінів у казну клану', NULL, '2026-07-20 06:08:48.002', '2026-07-24 05:18:22.044', 'CARDS');


ALTER TABLE public."ClanQuest" ENABLE TRIGGER ALL;

--
-- Data for Name: ClanWar; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."ClanWar" DISABLE TRIGGER ALL;



ALTER TABLE public."ClanWar" ENABLE TRIGGER ALL;

--
-- Data for Name: ClanWarParticipant; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."ClanWarParticipant" DISABLE TRIGGER ALL;



ALTER TABLE public."ClanWarParticipant" ENABLE TRIGGER ALL;

--
-- Data for Name: DailyRewardClaim; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."DailyRewardClaim" DISABLE TRIGGER ALL;



ALTER TABLE public."DailyRewardClaim" ENABLE TRIGGER ALL;
...
INSERT INTO public."Location" (id, name, emoji, "maxHp", "currentHp", "controllingClanId", "lastPayoutAt", "updatedAt") VALUES ('cmrstphac000ilsuzekdggrhw', 'Землі Вітрів', '🌬️', 1000000, 1000000, NULL, '2026-07-20 06:08:03.78', '2026-07-20 06:08:03.78');
INSERT INTO public."Location" (id, name, emoji, "maxHp", "currentHp", "controllingClanId", "lastPayoutAt", "updatedAt") VALUES ('cmrstphai000jlsuzorxm53al', 'Чорні Води', '🌊', 1000000, 1000000, NULL, '2026-07-20 06:08:03.786', '2026-07-20 06:08:03.786');
INSERT INTO public."Location" (id, name, emoji, "maxHp", "currentHp", "controllingClanId", "lastPayoutAt", "updatedAt") VALUES ('cmrstphap000klsuzg7684bbk', 'Таємні Землі', '🌲', 1000000, 1000000, NULL, '2026-07-20 06:08:03.793', '2026-07-20 06:08:03.793');
INSERT INTO public."Location" (id, name, emoji, "maxHp", "currentHp", "controllingClanId", "lastPayoutAt", "updatedAt") VALUES ('cmrstpha3000hlsuzjgbgtars', 'Землі Вогню', '🔥', 1000000, 885000, NULL, '2026-07-20 06:08:03.771', '2026-07-22 05:16:33.925');


ALTER TABLE public."Location" ENABLE TRIGGER ALL;

--
-- Data for Name: PityCounter; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."PityCounter" DISABLE TRIGGER ALL;



ALTER TABLE public."PityCounter" ENABLE TRIGGER ALL;

--
-- Data for Name: QuestProgress; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."QuestProgress" DISABLE TRIGGER ALL;
...
ALTER TABLE public."QuestProgress" ENABLE TRIGGER ALL;
...
ALTER TABLE public."TradeListing" DISABLE TRIGGER ALL;



ALTER TABLE public."TradeListing" ENABLE TRIGGER ALL;

--
-- Data for Name: UserAchievement; Type: TABLE DATA; Schema: public; Owner: postgres
--

ALTER TABLE public."UserAchievement" DISABLE TRIGGER ALL;



ALTER TABLE public."UserAchievement" ENABLE TRIGGER ALL;
...
\unrestrict WnSviwag5TdbMYl95oGVxCjojcZCQHSMXca0SsY8jIS1KAK6eo3PIBpbhP8tRKc
